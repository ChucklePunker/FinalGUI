...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		drawPanel.setBackgroundImage(Util.getImageResource("resources/images/moonscape.jpeg"));
    ...
    private class ChooseBackgroundAction extends AbstractAction {
    	String text;
		Icon fileOpenIcon = new ImageIcon("src/resources/action_icons/fileopen.png");
		//Icon
    	ChooseBackgroundAction(String text) {
    		...
    		if (text.equals("Color...")) {
				putValue(Action.SMALL_ICON, fileOpenIcon);
				putValue(Action.SHORT_DESCRIPTION, "Select a background color");
			} else if (text.equals("Custom...")) {
				BufferedImage cust = new BufferedImage(32, 32, BufferedImage.TYPE_INT_ARGB);
				Graphics g = cust.createGraphics();
				g.setColor(Color.LIGHT_GRAY);
				g.fillRect(0, 0, 32, 32);
				g.setColor(Color.DARK_GRAY);
				g.fillRect(6,6, 20,20);
				g.dispose();
				putValue(Action.SMALL_ICON, new ImageIcon(cust));
